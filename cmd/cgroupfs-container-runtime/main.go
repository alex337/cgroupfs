...
const (
	...
	configFilePath = "cgroupfs-container-runtime/config.toml"

	hookDefaultFilePath = "/usr/bin/cgroupfs-container-runtime-hook"
)
...
func getConfig() (*config, error) {
	...
	cfg.debugFilePath = toml.GetDefault("cgroupfs-container-runtime.debug", "/dev/null").(string)
